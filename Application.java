public class Application {
    public static void main(String[] args){
        ...
        String candidateName = "Srinu Kakumani";
        String fatherName = "Kakumani Subba Rao";
        String motherName = "Kakumani Rameswari";
        String category = "GEN"; // GEN / OBC / SC / ST / Minority / Others
        String fatherOccupation = "Farmer";
        double annualIncome = 100000.00;
        String address = "1-2-3/3/4,Kakumani Vari Palem";
        String post = "Kandukur";
        String district = "Nellore";
        int pincode = 523105;
        String state = "Andhra Pradesh";
        String studentMobile = "8309582973";
        String parentMobile = "8309582973";
        String email = "srinivaskakumani614@gmail.com";
       
        String domicileState = "Andhra Pradesh";

        String branchName = "ECE";

        String aadharNumber = "9566 3567 6543";

        String secondaryBoard = "BIEAP";
        int secondaryYear = 2019;
        String secondarySchool = "Sri Chaitanya";
        double secondaryCGPA = 9.8;
        double secondaryTotalMarks = 576;
        double secondaryPercentage = 98.0;

        String srSecondaryBoard = "BIEAP";
        int srSecondaryYear = 2021;
        String srSecondarySchool = "Sri Chaitanya";
        double srSecondaryCGPA = 9.0;
        double srSecondaryTotalMarks = 906;
        double srSecondaryPercentage = 90.6;
